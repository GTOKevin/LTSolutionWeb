...
export function MantenimientoNuevoPage() {
    ...
    const title = createdId ? 'Gestión de Mantenimiento' : 'Registrar Ingreso a Taller';
    const subtitle = 'Complete los detalles para iniciar un nuevo registro o actualizarlo';
