...
export function MisViajesKPIs({ total, abiertos, cerrados }: MisViajesKPIsProps) {
    return (
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            ...
            <Box sx={{ bgcolor: 'background.paper', p: 3, borderRadius: 3, minWidth: 160, border: '1px solid', borderColor: 'divider', borderLeft: '4px solid', borderLeftColor: 'warning.main' }}>
                <Typography variant="overline" fontWeight={800} color="text.secondary" sx={{ letterSpacing: '0.1em', display: 'block', mb: 1 }}>ABIERTOS VISIBLES</Typography>
