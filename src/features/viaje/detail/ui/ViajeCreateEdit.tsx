...
export function ViajeCreateEdit({ viaje, isViewOnly, options, isPending }: Props) {
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 6, md: 3 }}>
                <FormDatePicker label="Fecha Partida" registration={register('fechaPartida')} disabled={isViewOnly} />
            </Grid>
            <Grid size={{ xs: 6, md: 3 }}>
                <FormDatePicker label="Fecha Llegada" registration={register('fechaLlegada')} disabled={isViewOnly} />
            </Grid>
            <Grid size={{ xs: 6, md: 3 }}>
                <FormDatePicker label="Fecha Descarga" registration={register('fechaDescarga')} disabled={isViewOnly} />
            </Grid>
            <Grid size={{ xs: 6, md: 3 }}>
                <FormDatePicker label="Fecha Llegada Base" registration={register('fechaLlegadaBase')} disabled={isViewOnly} />
            </Grid>
            <Grid size={{ xs: 6, md: 4 }}>
                <TextField
                    label="Km Inicio"
