                            ...
                            <Grid size={{xs:12,md:6}} key={item.viajePermisoID}>
                                <Paper 
                                    ...
                                    sx={{ 
                                        ...
                                        display: 'flex',
                                        gap: 2,
                                        borderColor: status.color === 'error' ? alpha(theme.palette.error.main, 0.5) : 
                                                     status.color === 'warning' ? alpha(theme.palette.warning.main, 0.5) : 'divider',
                                        transition: 'all 0.2s',
                                        '&:hover': { boxShadow: 2 }
                                    }}
                                >
                                    ...
                                    <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                                        <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                                            ...
                                            <IconButton size="small" onClick={(e) => handleMenuOpen(e, item)} sx={{ mt: -0.5, mr: -1 }}>
