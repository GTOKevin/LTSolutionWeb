...
import type { ResumenGeneralData } from './ResumenGeneralTab';
import { createResumenGeneralDataFromViaje, getViajeEditTabs, ViajeEditContent } from '@features/viaje/edit';
