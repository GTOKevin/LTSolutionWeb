...
export function ViajesTable({ viajes, onEdit, onDelete, onView }: Props) {
        ...
        >
            <Table size="medium">
                <TableHead sx={{ bgcolor: alpha(theme.palette.background.default, 0.6) }}>
                    <TableRow>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase', fontSize: '0.75rem' }}>Cliente</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase', fontSize: '0.75rem' }}>Ruta</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase', fontSize: '0.75rem' }}>Recursos (Activos)</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase', fontSize: '0.75rem' }}>Carga</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase', fontSize: '0.75rem' }}>Estado</TableCell>
                    ...
                    {viajes.length === 0 ? (
                        <TableRow>
                            <TableCell colSpan={7} align="center" sx={{ py: 6 }}>
                                <Typography color="text.secondary">No se encontraron viajes registrados.</Typography>
                            </TableCell>
                        </TableRow>
                    ) : (
                        viajes.map((viaje) => {
