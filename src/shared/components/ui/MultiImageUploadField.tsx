...
interface MultiImageUploadFieldProps {
    ...
    minItems?: number;
    /**
     * 'grid' (default): miniaturas en grid con upload directo (compresión + archivoApi),
     * preview con galería y delete por imagen. Pensado para evidencias adjuntas.
     * 'slots': slots independientes, cada uno con un ImageUpload por evidencia.
     */
    layout?: 'grid' | 'slots';
}
...
export function MultiImageUploadField(props: MultiImageUploadFieldProps) {
    const { layout = 'grid', ...rest } = props;
    return layout === 'slots' ? <MultiImageSlots {...rest} /> : <MultiImageGrid {...rest} />;
}